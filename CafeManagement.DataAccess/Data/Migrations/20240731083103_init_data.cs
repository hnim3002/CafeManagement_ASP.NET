    ...
    public partial class init_data : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkSchedules", x => new { x.Id, x.CafeId, x.EmployeeId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_WorkSchedules_Cafes_CafeId",
                        column: x => x.CafeId,
                        principalTable: "Cafes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Inventories", x => new { x.ProductId, x.CafeId });
                    table.ForeignKey(
                        name: "FK_Inventories_Cafes_CafeId",
                        column: x => x.CafeId,
                        principalTable: "Cafes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReceiptDetails", x => new { x.ProductId, x.CafeId, x.ReceiptId });
                    table.ForeignKey(
                        name: "FK_ReceiptDetails_Inventories_ProductId_CafeId",
                        columns: x => new { x.ProductId, x.CafeId },
                        principalTable: "Inventories",
                        principalColumns: new[] { "ProductId", "CafeId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
